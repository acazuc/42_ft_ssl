...
/*   Updated: 2018/10/08 12:53:48 by acazuc           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_hash		g_hash_sha384 = {"SHA384",
	(t_hash_init)sha384_init,
	(t_hash_update)sha384_update,
	(t_hash_final)sha384_final,
	48, 128, sizeof(t_sha384_ctx)};

static uint64_t g_sha384_k[128] = {
...
static void	sha384_loop(int i, uint64_t *tmp, uint64_t *w)
{
	uint64_t	tmp1;
	uint64_t	tmp2;
	uint64_t	tmp3;
	...
	tmp3 = tmp[7] + tmp1 + tmp2 + g_sha384_k[i] + w[i];
