...
/*   Updated: 2018/10/08 12:18:51 by acazuc           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_hash		g_hash_sha224 = {"SHA224",
	(t_hash_init)sha224_init,
	(t_hash_update)sha224_update,
	(t_hash_final)sha224_final,
	28, 64, sizeof(t_sha224_ctx)};
...
static void	sha224_loop(int i, uint32_t *tmp, uint32_t *w)
{
	uint32_t	tmp1;
	uint32_t	tmp2;
	uint32_t	tmp3;
