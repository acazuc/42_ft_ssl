...
/*   Updated: 2018/10/08 12:56:26 by acazuc           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_hash		g_hash_sha512 = {"SHA512",
	(t_hash_init)sha512_init,
	(t_hash_update)sha512_update,
	(t_hash_final)sha512_final,
	64, 128, sizeof(t_sha512_ctx)};

static uint64_t g_sha512_k[128] = {
...
static void	sha512_loop(int i, uint64_t *tmp, uint64_t *w)
{
	uint64_t	tmp1;
	uint64_t	tmp2;
	uint64_t	tmp3;
