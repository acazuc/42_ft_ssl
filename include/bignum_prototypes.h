...
int				bignum_rand(t_bignum *bignum, uint32_t bits, int top
		, int bottom);
...
int				bignum_mod_word(t_bignum_word *r, t_bignum *a
		, t_bignum_word b);
int				bignum_exp(t_bignum *r, t_bignum *a, t_bignum *p);
int				bignum_exp_op(t_bignum *r, t_bignum *a, t_bignum *p);
int				bignum_mod_exp(t_bignum *r, t_bignum *a, t_bignum *p
		, t_bignum *m);
...
int				bignum_is_prime(t_bignum *bignum, uint32_t n
		, uint32_t *passed);
int				bignum_is_prime_witness(t_miller_ctx *ctx
		, t_bignum *bignum, uint32_t *passed);
