...
{
	iv="8877665544332211"
	#./ft_ssl $1 -a -e -k $2 -v $iv -i $3 | hexdump -C
	#openssl $1 -a -e -K $2 -iv $iv -in $3 | hexdump -C
...
test_bignum_all()
{
	...
	echo
	test_bignum "add_negative_pns" 5 + -2 3
	test_bignum "add_negative_pni" 2 + -5 -3
	test_bignum "add_negative_nps" -6 + 4 -2
	test_bignum "add_negative_npi" -5 + 9 4
	test_bignum "add_negative_nns" -5 + -4 -9
	test_bignum "add_negative_nni" -3 + -9 -12
	echo
	...
	echo
	test_bignum "sub_negative_pns" 5 - -2 7
	test_bignum "sub_negative_pni" 3 - -7 10
	test_bignum "sub_negative_nps" -7 - 4 -11
	test_bignum "sub_negative_npi" -2 - 5 -7
	test_bignum "sub_negative_nns" -9 - -3 -6
	test_bignum "sub_negative_nni" -4 - -9 5
	echo
